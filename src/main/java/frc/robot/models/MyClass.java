...
public class MyClass {
  ...
  public static String jsonTestString =
      "[{\"objectLabel\":\"tag36h11\", \"x\": 14.0, \"y\":-2.3, \"z\":36.5, \"confidence\": 1.0, \"xa\":0.0,\"ya\":2.0,\"za\":-2.0}, {\"objectLabel\":\"tag36h12\", \"x\": 14.0, \"y\":-2.3, \"z\":36.5, \"confidence\": 1.0, \"xa\":0.0,\"ya\":2.0,\"za\":-2.0}, {\"objectLabel\":\"note\", \"x\": 2, \"y\":8, \"z\":43, \"confidence\":0.78, \"xa\":0.0,\"ya\":0.0,\"za\":0.0}]";
  ...
  public static void main(String args[]) {
    ...
    // Warning: must use try catch in case the user tries to access a Rotation object inside a plain
    // Detection object
    // TODO: we can fix this by using a different architecture but that syntax is slightly more
    // complicated
    // Before using rotation, make sure it is not a note detection
    // DetectionList gsonOut = gson.fromJson(jsonTestString, DetectionList.class); // deserializes
    // json into target2
